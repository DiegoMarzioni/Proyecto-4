    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden flex items-center justify-center px-6 py-20">
      ...
      <div className="relative z-10 max-w-md w-full opacity-0 translate-y-8 animate-[fadeInUp_0.8s_ease-out_0.3s_forwards]">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-light text-white mb-2 opacity-0 -translate-y-4 animate-[fadeInDown_0.6s_ease-out_0.1s_forwards]">Iniciar Sesión</h1>
          <p className="text-gray-300 opacity-0 -translate-y-4 animate-[fadeInDown_0.6s_ease-out_0.2s_forwards]">Accede a tu cuenta para continuar</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/50 transition-all duration-300 backdrop-blur-sm group-hover:bg-white/25"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-300 hover:text-white transition-colors cursor-pointer">
                  Recordarme
                </label>
              </div>
              <Link href="/forgot-password" className="text-sm text-yellow-300 hover:text-yellow-200 transition-all duration-200 hover:underline">
          ...
          <div className="mt-6 mb-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-transparent text-gray-300">O continúa con</span>
              </div>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <button className="w-full inline-flex justify-center py-3 px-4 border border-white/30 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all duration-300 backdrop-blur-sm transform hover:scale-105 active:scale-95 group">
        ...
        <div className="text-center mt-6 opacity-0 translate-y-4 animate-[fadeInUp_0.6s_ease-out_0.6s_forwards]">
          <p className="text-gray-300">
            ...
            <Link href="/register" className="text-yellow-300 hover:text-yellow-200 font-medium transition-all duration-200 hover:underline">
              Regístrate aquí
            </Link>
          </p>
        </div>
